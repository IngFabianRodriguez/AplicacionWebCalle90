...
$sql='SELECT * FROM equipo ORDER BY ActivoFijo DESC';
...
<?php if ($_SESSION['cargo']=="Desarrollador" || $_SESSION['cargo']=="Coordinador" ) {
   ?>
        ...
        <a href="/Calle90/prestamo/indexPrestamo.php?ActivoFijo=<?php echo $r["ActivoFijo"];?>" class="btn btn-sm btn-danger">Préstamo</a><br>
